...
public class DrawingGame extends ApplicationAdapter {
    ...
    public void create() {
        ...
        outline = new Texture(Gdx.files.internal("data/background.jpg"));
        //color = new Texture(Gdx.files.internal("data/smiley_color.png"));
        ...
        drawable = new DrawablePixmap(new Pixmap(Gdx.graphics.getWidth(),
                Gdx.graphics.getHeight(), Format.RGBA4444), 1);
    ...
    private static class DrawablePixmap implements Disposable {
       ...
       //
       // private final Color clearColor1= new Color()
        private final Color clearColor = new Color(1, 1, 1, 1);
        private final Color drawColor = new Color(145, 145, 145, 0.5f);
